...
data class UserPostsResponseData(@SerializedName("current_page"   ) var currentPage  : Int?             = null,
                                 @SerializedName("data"           ) var data         : ArrayList<UserPostsData>  = arrayListOf(),
                                 ...
                                 @SerializedName("links"          ) var links        : ArrayList<UserPostsLinks> = arrayListOf(),
