...
data class UserProfilePosts(
    ...
    @SerializedName("intrest_id"       ) var intrestId      : String?           = null,
    ...
    @SerializedName("user_data"        ) var userData       : UserProfileData?         = UserProfileData(),
    @SerializedName("images"           ) var postImages         : ArrayList<UserPostsImages> = arrayListOf(),
